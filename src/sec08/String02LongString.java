...
public class String02LongString {
	...
	public static void main(String[] args) {
		...
		System.out.println("분리된 단어의 갯수는 : " + words.length);
		...
		// 문제 1. 위의 str 데이터 중 "HTML5"라는 단어가 몇번 노출되는지
		...
		System.out.println("1. HTML5 단어는 총 : " + count + "회 노출 되었습니다.");
		...
		// 문제 2. 위의 str 데이터를 모두 역순(space)기준으로 
		// resultStr 변수 저장하여 클릭
